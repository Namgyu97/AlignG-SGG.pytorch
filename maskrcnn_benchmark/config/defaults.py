...
# AlignG auxiliary loss weights (SGGPredictor)
_C.MODEL.ROI_RELATION_HEAD.LOSS_WEIGHT_L21 = 1.0   # cosine prototype regularization (L_sim)
_C.MODEL.ROI_RELATION_HEAD.LOSS_WEIGHT_DIST = 1.0  # Euclidean prototype repulsion (L_proto)
_C.MODEL.ROI_RELATION_HEAD.LOSS_WEIGHT_DIS = 1.0   # prototype-based metric learning (L_euc)
