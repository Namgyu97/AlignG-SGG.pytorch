...
# NOTE: image retrieval is a PE-NET baseline feature, not used by AlignG itself.
# Set these paths to the scene-graph json files produced by tools/relation_test_net.py
# (see maskrcnn_benchmark/image_retrieval/S2G-RETRIEVAL.md) before running.
output_path = './checkpoints/image_retrieval/sg_of_causal_sgdet_ctx_only_%s_%d.pytorch'
sg_train_path = './checkpoints/image_retrieval/train_sg_of_causal_sgdet_ctx_only.json'
sg_test_path = './checkpoints/image_retrieval/test_sg_of_causal_sgdet_ctx_only.json'
sg_val_path = './checkpoints/image_retrieval/val_sg_of_causal_sgdet_ctx_only.json'
